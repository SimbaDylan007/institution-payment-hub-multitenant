...
export default function Dashboard() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-70 dark:bg-gradient-to-br dark:from-[#1A2E44] dark:to-[#0E1B29] dark:text-white">
            <Header />
                                            ...
                                            {isSuperAdmin && (
                                                <Select value={selectedInstitutionId} onValueChange={setSelectedInstitutionId}>
                                                    ...
                                                    <SelectContent className="dark:bg-gray-800">
                                                        <SelectItem value="all">View All Institutions</SelectItem>
