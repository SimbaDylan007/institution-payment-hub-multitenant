...
1. Java 11 or higher
2. Maven
3. MySQL Server running on 213.199.47.95:3306
...
2. Make sure the MySQL server is running on 213.199.47.95:3306 with the username "root" and no password (or update the application.properties file with your credentials).
...
```bash
curl -X POST "/api/payments/all-payments" \
